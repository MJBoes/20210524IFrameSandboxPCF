...
export class DTSIFrameSandbox implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	private elemStyle:HTMLStyleElement;
	private elemWrap:HTMLDivElement;
	private elemIFrame:HTMLIFrameElement;
	/**
	 * Empty constructor.
	 */
	constructor()
